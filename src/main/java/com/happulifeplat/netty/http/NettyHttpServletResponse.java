...
public class NettyHttpServletResponse implements HttpServletResponse {
    ...
    private static final Locale DEFAULT_LOCALE = Locale.US;                    // Locale.getDefault();
    private static final String DEFAULT_CHARACTER_ENCODING = Charsets.ISO_8859_1.name();   // Charsets.UTF_8.name();
